...
\only<2>{
	leading to the discrete weak formulation: find $v_h \in V_h, \; \bm{\sigma}_h \in \Sigma_h$ such that
		\begin{equation*}
		\begin{aligned}
			\inner[L^2(\Omega)]{\psi_v}{\kappa^{-1}\partial_t v_h} &= \inner[L^2(\Omega)]{ \psi_v}{\div\bm{\sigma}_h}, \\
			\inner[L^2(\Omega)]{\bm{\psi}_\sigma}{\rho \partial_t \bm{\sigma}_h} &= \inner[L^2(\Omega)]{\bm{\psi}_\sigma}{\grad v_h}, \\
		\end{aligned} \qquad
		\begin{aligned}
...
\only<1>{
	...
	Find $v_h \in V_h, \; \bm{\sigma}_h \in \Sigma_h$ such that
		\begin{equation*}
			\begin{aligned}
				\inner[L^2(\Omega)]{\psi_v}{\kappa^{-1}\partial_t v_h} &= +\inner[L^2(\Omega)]{ \psi_v}{\div\bm{\sigma}_h}, \\
				\inner[L^2(\Omega)]{\bm{\psi}_\sigma}{\rho \partial_t \bm{\sigma}_h} &= -\inner[L^2(\Omega)]{\div\bm{\psi}_\sigma}{v_h}, \\
			\end{aligned} \qquad
			\begin{aligned}
				\forall \psi_v &\in  V_h, \\
...
\only<2>{
	\begin{block}{Mixed $\grad$ formulation (Cohen 2000)}
		...
		\begin{equation*}
			\begin{aligned}
				\inner[L^2(\Omega)]{\psi_v}{\kappa^{-1}\partial_t v_h} &= -\inner[L^2(\Omega)]{\grad \psi_v}{\bm{\sigma}_h}, \\
				\inner[L^2(\Omega)]{\bm{\psi}_\sigma}{\rho \partial_t \bm{\sigma}_h} &= +\inner[L^2(\Omega)]{ \bm{\psi}_\sigma}{\grad v_h}, \\
			\end{aligned} \qquad
			\begin{aligned}
				\forall \psi_v &\in V_h, \\
