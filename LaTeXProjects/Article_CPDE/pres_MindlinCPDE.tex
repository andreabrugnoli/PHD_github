...
\begin{frame}{Hamiltonian energy}
The Hamiltonian (total energy)  is the sum of kinetic and potential energy
\begin{equation*} 
...
The energy variables are defined as in \footfullcite{MacchelliMindlin}
\begin{equation*}
\begin{aligned}
...
\end{bmatrix}
\end{equation*}
\begin{block}{Strong form for theMindlin plate}
	\begin{equation*}
	\begin{cases}
...
\[J = \textcolor{red}{J_{\text{div}}} + \textcolor{blue}{J_{\text{grad}}} + J_{\bm{I}}\] %\vspace{1cm}
\onslide*<1>{
\begin{equation*}
J = 
\begin{bmatrix}
...
\onslide<5>{From these definitions, it holds
...
If the operator $\textcolor{red}{J_{\text{div}}}$ is integrated by parts  then 
\begin{equation}
(v, Je) = \textcolor{blue}{j_{\text{grad}}}(v, e) + \textcolor{blue}{f_{N}}(v).
\end{equation}
\onslide*<1>{The bilinear form 
	\begin{align*}
...
If the operator $\textcolor{blue}{J_{\text{grad}}}$ is integrated by parts  then 
\begin{equation}
...
\item Number of finite elements $5 \times 5$;
...
\begin{center}
\onslide*<2>{\includemovie[poster, mouse=true, controls=true, toolbar=true, autostop=true]{10cm}{6cm}{./Videos/Video_n1.mp4}}
\onslide*<3>{
...
\begin{equation}
g(y, t) = \begin{cases}
10^6 \, \sin \left( \frac{2 \pi}{L} y \right) \; [Pa \cdot m], \; &\forall t< 0.25 \, t_{\text{fin}}, \\
0, \; &\forall t\geq 0.25 \, t_{\text{fin}}. \\
\end{cases}
\end{equation}
}
\begin{center}
\onslide*<2>{\includemovie[poster, mouse=true, controls=true, toolbar=true, autostop=true]{10cm}{6cm}{./Videos/Video_n2.mp4}}
	\onslide*<3>{
...
\begin{center}
	\onslide*<1>{\includemovie[poster, mouse=true, controls=true, toolbar=true, autostop=true]{10cm}{6cm}{./Videos/Video_n3.mp4}}
	\onslide*<2>{
