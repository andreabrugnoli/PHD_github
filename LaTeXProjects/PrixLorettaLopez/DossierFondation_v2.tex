...
\includepdf[pages=1-]{./Letters/LetterCERFACS-MORPHEUS.pdf}
\includepdf[pages=1-]{./Letters/Lettre_Soutien_Lapeyre.pdf}
\includepdf[pages=1-3]{./Letters/LettreCEA.pdf}
\includepdf[pages=1-]{./Letters/LetterMehrmann.pdf}
\includepdf[pages=1-]{./Letters/Letter_Stramigioli.pdf}
\includepdf[pages=1-]{./Letters/LettrePussot.pdf}
