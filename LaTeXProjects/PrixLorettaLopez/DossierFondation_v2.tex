...
Pour accomplir les objectifs, des recrutements seront effectués :
	...
	\begin{center}
		...
		\end{ganttchart}
	\end{center}		
	\caption{Gaant Chart du projet. \review{Rajouter livrables}}
\end{figure}
