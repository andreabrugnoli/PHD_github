...
\newcites{A,C,CN}{{Articles dans des revues internationales à comité de lecture
...
Le premier lot des travaux (\textbf{WP1}) cherche donc à résoudre les problématiques liées au couplage multiphysique, d'une manière \`a garantir le respect des flux d'energie entre différentes physiques (mécanique, dynamique des fluides et électromagnétisme). Ces modèles numériques devront retenir les propriétés physiques du problème (conservation d’énergie globale, traçage des échanges d’énergie entre les différents sous-systèmes, invariants du problème). \\
...
\begin{figure}[htb]
	\begin{center}
		\begin{ganttchart}[y unit title=0.6cm,
			...
			\ganttbar[bar/.append style={fill=red!50}]{1$^\circ$ th\`ese}{4}{21} \\
			\ganttbar[bar/.append style={fill=cyan!70}]{2$^\circ$ th\`ese}{10}{27} \\
			\ganttbar[bar/.append style={fill=orange!70}]{3$^\circ$ th\`ese}{13}{30} \\
			\ganttbar[bar/.append style={fill=orange!70}]{Post-Doc}{16}{27} \\
			\ganttmilestone{1$^\circ$ livrable}{18}\\
			\ganttmilestone{2$^\circ$ livrable}{24}\\	
			\ganttmilestone{3$^\circ$ livrable}{27}\\			
			...
			%\ganttlink[link/.append style={blue,  ultra thick}]{elem5}{elem8}		
		\end{ganttchart}
	\end{center}		
	\caption{Gantt Chart du projet. \sqbox{red!50} \textcolor{red!50}{\textbf{WP1}}, \ \sqbox{cyan!70} \textcolor{cyan!70}{\textbf{WP2}}, \ \sqbox{orange!70} \textcolor{orange!70}{\textbf{WP3}}.} 
\end{figure}
...
\begin{center}
	\begin{tabular}{|c|ccccc|}
		...
		Frais mission &  & $10000$ & $10000$ & $20000$ & $20000$\\
...
\end{center}
	...
	{
		\nociteA{brugnoli2019ammmin,brugnoli2019ammkir,brugnoli2020msd,brugnoli2021ther,brugnoli2021num,califano2021,brugnoli2022df}
		\bibliographystyleA{unsrt}
		\bibliographyA{biblio_dossierLL}
		
		\nociteC{brugnoli2019cpde,brugnoli2019cdc,cardoso2019cdc,brugnoli2020wc,brugnoli2020mtns,brugnoli2021vk,cherifi2021data,rashad2021ext}
		\bibliographystyleC{unsrt}
		\bibliographyC{biblio_dossierLL}  
		
		\nociteCN{brugnoli2021siamcse}
		\bibliographystyleCN{unsrt}
		\bibliographyCN{biblio_dossierLL}   
	}
...
\includepdf[pages=1-]{./Letters/LettreAIRBUS_Signed.pdf}
\includepdf[pages=1-]{./Letters/Letter_Stramigioli.pdf}
...
\begin{tikzpicture}[remember picture,overlay]
	\draw ([yshift=-10pt]current page.west) --
