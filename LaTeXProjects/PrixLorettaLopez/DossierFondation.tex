...
La dernière expérience que je souhaite mentionner a été mon déménagement aux Pays-Bas pour travailler au sein du projet Portwings. Ce ambitieux projet demande des compétences extrêmement diversifiées et chaque membre est en effet responsable d'une partie spécifique. J'ai pu m'intégrer rapidement et interagir avec des chercheurs ayants des compétences très différentes des miennes, en arrivant à instaurer une discussion scientifique très constructive. Mon travail à déjà donné lieu à un article de revue soumis à un journal très réputé dans le domaine de la physique computationnelle \citearticle{brugnoli2022df}. 
