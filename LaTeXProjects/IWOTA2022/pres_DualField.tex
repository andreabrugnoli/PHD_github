...
\begin{figure}[tbh]%
	...
	\subfloat[][Boundary splitting.]{%
		\label{fig:domain}%
		\includegraphics[width=0.33\columnwidth]{domain.pdf}}%
	\hspace{8pt}%
	\subfloat[][Computational mesh]{%
		\label{fig:mesh}%
		\includegraphics[width=0.36\columnwidth]{mesh.pdf}}%
	\\
	\subfloat[][Dofs 0-form.]{%
		\label{fig:zero_form}%
		\includegraphics[width=0.35\columnwidth]{zero_form.pdf}}
	\hspace{8pt}%
	\subfloat[][Dofs 1-form.]{%
		\label{fig:one_form}%
		\includegraphics[width=0.35\columnwidth]{one_form.pdf}}
