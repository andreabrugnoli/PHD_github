...
\begin{tcolorbox}[title=Revision pages 17 to 25 (Reviewer No. 1 -- Comment a),colframe=colorRevBG1]
...
System that is conservative with respect to the storage function $s(\mathbf{u}, \mathbf{y}) = \mathbf{u}^\top \mathbf{y}$.
