...
\begin{itemize}
	...
	\item A convergence study has been added to  section 6. The average cou time and time step have been added for the examples. 
\end{itemize}
\end{tcolorbox}
...
\end{quotebox}
The considered numerical examples represent a validation of the proposed formulation with respect to simple benchmark problems available in the literature. The numerical solutions are consistent with publications [14, 17]. \\
