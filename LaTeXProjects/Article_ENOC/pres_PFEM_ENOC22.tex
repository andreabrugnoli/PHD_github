...
%\thanks{\includegraphics[height=0.1\textwidth]{INFIDHEM-logo} \hspace{.5cm}
...
\begin{frame}{Impedance Boundary Condition (IBC)}
	...
	\end{alertblock}
	\vfill
	\onslide<3-> Add \textbf{impedance ports} $(\flo_i, \eff_i)$ and \textbf{dissipative constitutive relation} $\eff_i = \Zo \flo_i$,\vfill
...
\frame{\frametitle{Shallow Water Equations: applications}
	
	\begin{minipage}[t]{0.48\textwidth}
		%\hspace{-5cm}
		\centering
		\includemedia[
		addresource = /home/andrea/Videos/ENOC2022/Tsunami.mp4,
		activate=pageopen,
		width=6cm,height=3cm,
		width=0.5\paperwidth,
		flashvars={source=/home/andrea/Videos/ENOC2022/Tsunami.mp4
			&loop=true}
		]{}{VPlayer.swf}
	...
	\begin{minipage}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=0.7\linewidth]{sloshpool.jpg}
	...
	\begin{minipage}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=0.7\linewidth]{falcon1.jpg}
