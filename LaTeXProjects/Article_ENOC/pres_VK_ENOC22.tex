...
\begin{frame}{Mixed finite elements for elasticity}
	...
	This framework is well developed for linear wave propagation problems \footfullcite{arnold2006acta} and open source finite elements libraries implement them.
	\begin{figure}
		\centering
