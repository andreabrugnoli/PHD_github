...
\title{\LARGE \bf
	Interconnection of the Kirchhoff plate
...
\begin{figure}[t]
	\centering
	\subfloat[$t=0.5 \; t_{\text{end}}$]{\includegraphics[width=0.5\linewidth]{SnapNoRod_t50_cropped.eps}%
		\label{fig:NoRod_2}}
	\hfil
	\subfloat[$t= t_{\text{end}}$]{\includegraphics[width=0.5\linewidth]{SnapNoRod_t100_cropped.eps}%
		\label{fig:NoRod_4}}
	\caption{Snapshots at 2 different times ($t_{\text{end}} = 10 \,[ms]$) of a cantilever plate undergoing solicitation \eqref{eq:force_rod}.}
	\label{fig:IntNoRod}
\end{figure}

\begin{figure}[h!]
	\centering
	\subfloat[$t=0.5 \; t_{\text{end}}$]{\includegraphics[width=0.5\linewidth]{SnapRod_t50_cropped.eps}%
		\label{fig:Rod_2}}
	\hfil
	\subfloat[$t= t_{\text{end}}$]{\includegraphics[width=0.5\linewidth]{SnapRod_t100_cropped.eps}%
		\label{fig:Rod_4}}
	\caption{Snapshots at 2 different times ($t_{\text{end}} = 10 \,[ms]$) of a cantilever plate undergoing solicitation \eqref{eq:force_rod}. The plate is connected to a rigid rod in $x = L_x$. Note the different deformation amplitude with respect to Fig. \ref{fig:IntNoRod}.}
	\label{fig:IntRod}
\end{figure}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.5\linewidth]{HamiltonianDamped_cropped.eps}
...
\bibliography{biblio_CDCKirchhoff_revision}
