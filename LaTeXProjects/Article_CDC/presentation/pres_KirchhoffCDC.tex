...
\begin{frame}{The Kirchhoff plate case}
...
\end{pmatrix}
\]
\only<1>{Either the first line of the operator is integrated by parts
\begin{align*}
	\left(v, \mathcal{J}e \right) &= \int_{\Omega} \left\{ - v_1 \div\Div \bm{E}_2 + \bm{V}_2 \cddot \nabla^2 e_1 \right\} \d{\Omega} \\
	&= \underbrace{\int_{\Omega} \left\{ - \nabla^2 v_1 \cddot \bm{E}_2 + \bm{V}_2 \cddot \nabla^2 e_1 \right\} \d{\Omega}}_{j_{\text{Hess}}(\bm{v}, \bm{e})} + \underbrace{\int_{\partial \Omega} \left\{ v_1 q_n + \partial_{\bm{n}}v_1 M_{nn} \right\} \d{s}}_{b_N(\bm{v}, \bm{u}_\partial)_{\partial \Omega}}
\end{align*}
}
\only<2>{Either the second line of the operator is integrated by parts
	\begin{align*}
	\left(v, \mathcal{J}e \right) &= \int_{\Omega} \left\{ - v_1 \div\Div \bm{E}_2 + \bm{V}_2 \cddot \nabla^2 e_1 \right\} \d{\Omega} \\
	&= \underbrace{\int_{\Omega} \left\{ - v_1 \div\Div \bm{E}_2 + \div\Div \bm{V}_2 \, e_1 \right\} \d{\Omega}}_{j_{\nabla^2}(\bm{v}, \bm{e})} + \underbrace{\int_{\partial \Omega} \left\{ v_1 q_n + \partial_{\bm{n}}v_1 M_{nn} \right\} \d{s}}_{b_N(\bm{v}, \bm{u}_\partial)_{\partial \Omega}}
	\end{align*}
}
\end{frame}
