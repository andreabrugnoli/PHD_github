...
\nocitearticle{BrugnoliAMM_min,BrugnoliAMM_kir}
\bibliographystylearticle{unsrt}
\bibliographyarticle{cv_bibliography}                   % 'publications' is the name of a BibTeX file
\nociteconf{BrugnoliCPDE,BrugnoliCDC,CardosoCDC,BrugnoliWC,BrugnoliMTNS}
\bibliographystyleconf{unsrt}
\bibliographyconf{cv_bibliography}                   % 'publications' is the name of a BibTeX file
