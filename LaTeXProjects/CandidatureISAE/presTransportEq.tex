...
\begin{frame}{Cas 1 : résultats simulation}
...
\only<4>{
	...
	Cas instable ($c>0$ et schéma aval).
	%\mediabutton[
	%mediacommand=vidPlateRod:playPause
	%]{\fbox{Play/Pause}}
}
...
\begin{frame}{Cas 2 : résultats simulation}
	
	\only<1>{
		\centering
		\includemedia[
		label=vidcas2_sig_1,
		addresource=/home/andrea/Videos/PresEqTransport/cas2_sig_1.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas2_sig_1.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
	...
	\only<2>{
		\centering
		\includemedia[
		label=vidcas2_sig_dot5,
		addresource=/home/andrea/Videos/PresEqTransport/cas2_sig_dot5.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas2_sig_dot5.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
	...
	\only<3>{
		...
		\includemedia[
		label=vidcas2_sig_2,
		addresource=/home/andrea/Videos/PresEqTransport/cas2_sig_2.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas2_sig_2.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
	...
	\only<4>{
		\centering
		\includemedia[
		label=vidcas2_sig_mdot5,
		addresource=/home/andrea/Videos/PresEqTransport/cas2_sig_mdot5.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas2_sig_mdot5.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
		...
		Cas instable : $c<0$ et schéma amont.
		%\mediabutton[
		%mediacommand=vidPlateRod:playPause
		%]{\fbox{Play/Pause}}
	}
...
\begin{frame}{Cas 3 : Schéma explicite en temps et centré en espace}
	Schéma résultant : 
	$u_{i}^{n+1} = u_{i}^n - \frac{\sigma}{2}(u_{i+1}^n - u_{i-1}^n)$ 
...
\begin{frame}{Cas 3 : résultats simulation}
	
	\only<1>{
		\centering
		\includemedia[
		label=vidcas3_sig_dot5,
		addresource=/home/andrea/Videos/PresEqTransport/cas3_sig_dot5.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas3_sig_dot5.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
	...
	\only<2>{
		\centering
		\includemedia[
		label=vidcas3_sig_mdot5,
		addresource=/home/andrea/Videos/PresEqTransport/cas3_sig_mdot5.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas3_sig_mdot5.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
...
\begin{frame}{Cas 4 : Schéma implicite en temps et amont en espace}
	...
	\begin{tcolorbox}
		...
		\end{equation*}
Du fait que $|A(\xi)|\le 1 \iff |\frac{1}{A(\xi)}|\ge 1$ :
\begin{equation*}
	\left\vert\frac{1}{A(\xi)}\right\vert = |1 + \sigma- \sigma e^{-j\xi \Delta x}| \ge 1, \qquad \forall \sigma >0. 
\end{equation*}
\textbf{Si $\sigma>0$ (i.e. $c>0.$) ce schéma est toujours stable! Plus de CFL. }
		
	\end{tcolorbox}
	
Mais on aura $\forall \sigma >0,\; |A(\xi)|< 1$ : viscosité numérique toujours présente. 
\end{frame}



\begin{frame}{Cas 4 : résultats simulation}
	
	\only<1>{
		\centering
		\includemedia[
		label=vidcas4_sig_2,
		addresource=/home/andrea/Videos/PresEqTransport/cas4_sig_2.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas4_sig_2.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
	...
	\only<2>{
		...
		\includemedia[
		label=vidcas2_sig_1,
		addresource=/home/andrea/Videos/PresEqTransport/cas4_sig_1.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas4_sig_1.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
		...
		Cas stable : $c>0, \; \sigma=1$ (viscosité numérique)
		%\mediabutton[
		%mediacommand=vidPlateRod:playPause
		%]{\fbox{Play/Pause}}
	}
	...
	\only<3>{
		\centering
		\includemedia[
		label=vidcas4_sig_mdot5,
		addresource=/home/andrea/Videos/PresEqTransport/cas4_sig_mdot5.mp4,
		activate=pageopen, 
		deactivate=onclick,
		width=.8\textwidth, height=.7\textheight,
		flashvars={
			source=/home/andrea/Videos/PresEqTransport/cas4_sig_mdot5.mp4
			&%
			autoPlay=true&%
			loop=true%
		}
