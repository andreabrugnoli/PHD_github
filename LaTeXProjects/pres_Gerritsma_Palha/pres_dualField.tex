...
\end{frame}
				...
				\begin{equation*}
					\begin{aligned}
						...
						\begin{bmatrix}
							...
							\mathbf{0}
						\end{bmatrix}\dual{\mathbf{u}}^{2}_2, \\
						\mathbf{u}^{0}_1 &= 
						\begin{bmatrix}
	...
	\begin{frame}{Conclusion}
		...
		\begin{tcolorbox}[nobeforeafter, colframe=theme,title=Application oriented developments]%%
			\begin{itemize}
				\item efficient algebraic strategies for the resolution of large-scale pH models\footfullcite{guducu2022};
				\item model reduction of models arising from PDEs discretization\footfullcite{liljegren-sailer2022}.
			\end{itemize}
		\end{tcolorbox}
