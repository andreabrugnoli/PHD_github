...
\usepackage{media9}
\usepackage[backend=bibtex,doi=true,isbn=false,url=false,eprint=false]{biblatex}
...
\begin{columns}
	...
	\begin{column}{.5\textwidth}
		\begin{tcolorbox}
			\begin{figure}[t]
				\centering
				\includegraphics[width=1\textwidth]{floating_body_small.eps} 
			\end{figure}
		\end{tcolorbox}
	\end{column}
\end{columns}
...
\subsection{Canonical and modified momenta}
...
\begin{multicols}{2}
	\begin{itemize}
		\item Stability and convergence of FE\footfullcite{cohen2005};
