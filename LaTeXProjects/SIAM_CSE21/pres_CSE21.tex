...
\subsection{Boundary interconnection of the Kirchhoff plate}
...
\onslide*<2>{
\includegraphics[width=0.48\textwidth]{KP/HamiltonianNoRod.eps}
\includegraphics[width=0.48\textwidth]{KP/HamiltonianRod.eps}
}
...
\begin{frame}{Contribution and Outlook}
Contribution:
\begin{itemize}
		\item \onslide<2->{Development of a finite element based symplectic discretization easily re-implementable;}
\end{itemize}
Open problems and possible developments:
\begin{itemize}
	\item \onslide<3->{Finite element space for the multiplier satisfying the inf-sup condition;}
	\item \onslide<4->{Discretization: efficient finite element for the Kirchhoff plate based on div-div conforming elements \footfullcite{chen2020divDiv};}
	\item \onslide<5->{Model reduction: POD methods, $H_2$-optimal strategies or Krilov subspace methods\footfullcite{egger2018};}
	\item \onslide<6>{Observer based boundary control\footfullcite{toledo2020} and reduced LQG design for distributed control\footfullcite{wu2020reduced}.}
\end{itemize}
\end{frame}
...
\section{Details on the Kirchhoff plate interconnection}
...
\only<2>{\vspace{.5cm}\centering \includegraphics[width=0.6\textwidth]{KP/pp_interconnection.eps}}
