...
\end{equation}
The precompactness of the trajectories in the energy space is guaranteed since a bounded domain is considered (Rellich theorem). By the LaSalle' principle for infinite dimensional system \cite{henry2006geometric}, the point 
\begin{equation}
