...
\end{bmatrix}.
\end{equation}
The boundary conditions must now account for the symmetry condition at $r=0$, leading to the set of boundary conditions
\begin{align}
...
\end{align}
where $\Gamma_D, \; \Gamma_D$ denote the boundary partitions (see Fig. \ref{fig:bc_part_vibro}).
