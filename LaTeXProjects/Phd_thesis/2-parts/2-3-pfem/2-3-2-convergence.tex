...
We consider the weak formulation \eqref{eq:weak_min_div}, reported in Section \secref{sec:linearPfem}. For the subsequent numerical studies we will always consider clamped boundary conditions
\begin{equation}
