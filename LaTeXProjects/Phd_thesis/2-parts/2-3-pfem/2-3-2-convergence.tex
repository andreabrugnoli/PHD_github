...
\end{equation}
 ...
 Consider a regular triangulation $\mathcal{T}_h$ with elements $T$. The space of polynomials of order $k$ on a mesh cell is denoted by $P_k$. The following family of finite elements is conforming to the weak formulation \eqref{eq:weak_min_grad}
...
\begin{figure}[h!t]%
	...
	\caption{Error for the Mindlin plate using the AFW elements}%
	\label{fig:errorAFW}%
\end{figure}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchoff plate convergence result for SSSS test $k=1$.}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchoff plate convergence result for SSSS test $k=2$.}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchoff plate convergence result for SSSS test $k=3$.}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchoff plate convergence result for CSFS test $k=1$.}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchoff plate convergence result for CSFS test $k=2$.}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchoff plate convergence result for CSFS test $k=3$.}
