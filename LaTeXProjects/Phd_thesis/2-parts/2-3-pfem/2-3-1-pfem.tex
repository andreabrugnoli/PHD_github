...
\begin{remark}[Duality pairing for rigged Hilbert spaces]
	The integration by part formula establishes a duality pairing between Sobolev spaces. This duality pairing is then compatible with an $L^2$ inner-product in presence of a rigged Hilbert space (or Gelfand triple \cite{gel1964generalized}). We shall always use this representation. Therefore, the boundary integrals are  expressed as $L^2$ inner product over the boundary. 
\end{remark}
...
\end{aligned}
\end{equation}
We are now in a position to illustrate the methodology of the PFEM. 
...
{\subsection{Example: the irrotational shallow water equations}}
