...
\end{aligned}
\end{equation}
To get a finite-dimensional approximation the same procedure detailed in \secref{sec:pfem_gen} is followed. The only difference is that there is no need to discretize the constitutive relations as those are already incorporated in the dynamics. 
