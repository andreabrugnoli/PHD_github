...
\]
Then, the range of $\mathbf{P}$ automatically satisfies the constraints. Considering the transformation $ \mathbf{p} = \mathbf{P} \widehat{\mathbf{p}} $ and pre-multiplying the system by $\mathbf{P}^\top$ an equivalent ODE is obtained
\[
