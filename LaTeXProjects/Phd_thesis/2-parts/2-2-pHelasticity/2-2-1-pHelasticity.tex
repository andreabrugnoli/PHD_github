...
\[
\mathcal{G}(\alpha_h, \bm{\alpha}_v) = \frac{\partial_x \alpha_{v, y} - \partial_y \alpha_{v, x}}{\alpha_h} \begin{bmatrix}
0 & -1 \\
1 & 0 \\
\end{bmatrix}.
\]
...
\begin{equation}
	H = \energy{\rho \left(\partial_t \bm{u} \right)^2 + \bm{\varepsilon}}
\end{equation}
