...
\begin{paragraph}{Crucial points to obtain a rigorous proof}
	...
	Furthermore, the partition of the boundary due to the non uniform boundary control complicates the proof, since one has to properly connect the two partitions at the interconnection points.
\end{paragraph}
