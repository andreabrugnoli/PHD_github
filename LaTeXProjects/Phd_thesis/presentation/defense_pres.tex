...
\begin{frame}{Results for the Mindlin test}
	\only<1>{
		\begin{figure}[b]
			\begin{minipage}[b]{0.45\linewidth}
				\centering
...
\begin{overlayarea}{\textwidth}{\textheight}
	...
	\only<2>{
		...
		\begin{equation*}
		\begin{aligned}
		\mathcal{Z}(x, t) = \bm{1}\left\{ \frac{1}{3} L \leq \ x \ \leq \frac{2}{3} L, \,  t \geq 0.2 \ t_{\text{fin}} \right\} \mu_0 \, c_0, \\
	...
	\onslide*<4>{
		\begin{columns}
			\begin{column}{.3\textwidth}
				\includemedia[
				label=vidNoRod,
				addresource=/home/andrea/Videos/Videos_defense/wave_dae15.mp4,
				activate=pageopen,
				width=4cm, height=5cm,
				flashvars={
					source=/home/andrea/Videos/Videos_defense/wave_dae15.mp4
					&loop=true
				}
				]{}{VPlayer.swf}
				Reference solution
			...
			\begin{column}{.3\textwidth}
				\includemedia[
				label=vidNoRod,
				addresource=/home/andrea/Videos/Videos_defense/wave_dae10.mp4,
				activate=pageopen,
				width=4cm, height=5cm,
				flashvars={
					source=/home/andrea/Videos/Videos_defense/wave_dae10.mp4
					&loop=true
				}
				]{}{VPlayer.swf}
				DAE $h = L/10$
			...
			\begin{column}{.3\textwidth}
				\includemedia[
				label=vidRod,
				addresource=/home/andrea/Videos/Videos_defense/wave_ode10.mp4,
				activate=pageopen,
				width=4cm, height=5cm,
				flashvars={
					source=/home/andrea/Videos/Videos_defense/wave_ode10.mp4
					&loop=true
				}
				]{}{VPlayer.swf}
				ODE $h = L/10$
