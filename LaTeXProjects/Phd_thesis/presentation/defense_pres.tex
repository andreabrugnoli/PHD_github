...
\begin{bmatrix}
\rho h & 0 \\ 0 & \mathbb{C}_b \\
\end{bmatrix}
\diffp{}{t}
\begin{bmatrix}
\bm{e}_w \\ \bm{E}_\kappa \\
\end{bmatrix} &= 
\begin{bmatrix}
0 & -\div\Div \\ \nabla^2 & 0 \\
\end{bmatrix}
...
\partial_t w \\ \bm{M} \\
\end{bmatrix} \\
u_{\partial, \text{pl}} &= \bm{e}_w (x = L_x, y), \\
...
\begin{itemize}
	...
	\item Discretization: efficient finite element for the Kirchhoff plate based on div-div conforming elements \footfullcite{chen2020divDiv};
