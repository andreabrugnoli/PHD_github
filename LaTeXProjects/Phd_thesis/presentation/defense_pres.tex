...
\begin{equation*}
\begin{aligned}
u_{\partial, q} & = - k y_{\partial, q} = - k_q e_w|_{\Gamma_N}, \\
u_{\partial, m} & = - k y_{\partial, m} = - k_m \partial_{\bm{n}} e_w|_{\Gamma_N}, \\
\end{aligned} \qquad k_q>0.
\end{equation*}
...
The $\Hess$ operator is integrated by parts twice to enforce weekly the Neumann conditions. The Dirichlet condition is imposed weakly through a Lagrange multiplier. 
