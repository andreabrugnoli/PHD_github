...
\paragraph{Integration by parts for tensors} 
...
\end{equation}
\end{proof} 
The previous result can be specialized for symmetric tensor field \cite[Chapter 1]{boffi2013mixed}. Consider a smooth tensor-valued function $\bm{M} \in \mathbb{S} = \mathbb{R}^{d\times d}_{\text{sym}}$ and vector-valued function $\bm{b} \in \mathbb{V}=\mathbb{R}^d$. Then, it holds
