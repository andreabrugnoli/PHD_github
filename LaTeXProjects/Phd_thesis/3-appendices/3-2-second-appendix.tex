...
\begin{table}[hp]
	...
	\begin{tabular}{ccccc}
		\hline 
		\multirow{2}{*}{$\frac{1}{h}$} & \multicolumn{2}{c}{$||e_w - e_w^h||_{L^{\infty}(L^2)}$}  & \multicolumn{2}{c}{$||\bm{E}_\kappa - \bm{E}_\kappa^h||_{L^{\infty}(H^2)}$}   \\ 
		& Error & Order  & Error & Order  \\
		\hline 
		4  & 1.61e-02 & ---  & 7.48e-01 & ---  \\ 
...
\begin{table}[hp]
	...
	\begin{tabular}{ccccc}
		\hline 
		\multirow{2}{*}{$\frac{1}{h}$} & \multicolumn{2}{c}{$||e_w - e_w^h||_{L^{\infty}(H^1)}$}  & \multicolumn{2}{c}{$||\bm{E}_\kappa - \bm{E}_\kappa^h||_{L^{\infty}(H^1)}$}   \\ 
		& Error & Order  & Error & Order  \\
		\hline 
		4  & 5.93e-01 & ---  & 4.16e-00 & ---  \\ 
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchhoff plate convergence result for the HHJ scheme $k=1$ (SSSS test).}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchhoff plate convergence result for the HHJ scheme $k=2$ (SSSS test).}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchhoff plate convergence result for the HHJ scheme $k=3$ (SSSS test).}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchhoff plate convergence result for the BellDG3 scheme (SSSS test).}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchhoff plate convergence result for the HHJ scheme $k=1$ (CSFS test).}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchhoff plate convergence result for the HHJ scheme $k=2$ (CSFS test).}
...
\begin{table}[hp]
	...
	\captionsetup{width=0.95\linewidth}
	\vspace{1mm}
	\captionof{table}{Kirchhoff plate convergence result for the BellDG3 scheme (CSFS test).}
