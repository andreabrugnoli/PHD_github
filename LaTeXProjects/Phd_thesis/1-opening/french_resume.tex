...
\begin{equation*}
\bm{u}_\partial = \mathcal{N}_{\partial, 2} \displaystyle \delta_{\bm{\alpha}_2}H, \qquad  \bm{y}_\partial = \mathcal{N}_{\partial, 1} \displaystyle \delta_{\bm{\alpha}_1}H, 
\end{equation*}
ou bien
\begin{equation*}
\bm{u}_\partial = \mathcal{N}_{\partial, 1} \displaystyle \delta_{\bm{\alpha}_1}H, \qquad 
\bm{y}_\partial = \mathcal{N}_{\partial, 2} \displaystyle \delta_{\bm{\alpha}_2}H.
\end{equation*}
...
\bm{y}_\partial = \mathcal{N}_{\partial, 2} \displaystyle \bm{e}_2. 
\end{equation*}
