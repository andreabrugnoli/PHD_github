...
b_bd = v_pw * q_n * ds(2) + v_omn * M_nn * ds(2) + v_oms * M_ns * ds(2)
# b_bd = v_pw * q_n * ds(2) + v_omn * M_nn * ds(2) \
#         + v_pw * q_n * ds(3) + v_omn * M_nn * ds(3) + v_pw * q_n * ds(4) + v_omn * M_nn * ds(4)

b_mul = v_pw * q_n * ds(1) + v_omn * M_nn * ds(1) + v_oms * M_ns * ds(1)

# b_mul = v_pw * q_n * ds(1) + v_omn * M_nn * ds(1) + v_oms * M_ns * ds(1) + \
# v_pw * q_n * ds(2) + v_omn * M_nn * ds(2) + v_oms * M_ns * ds(2) + \
# v_pw * q_n * ds(3) + v_omn * M_nn * ds(3) + v_oms * M_ns * ds(3) + \
# v_pw * q_n * ds(4) + v_omn * M_nn * ds(4) + v_oms * M_ns * ds(4)

# Assemble the stiffness matrix and the mass matrix.

B, G = PETScMatrix, PETScMatrix
B = assemble(b_bd)
...
path_out = "/home/a.brugnoli/PycharmProjects/Mindlin_Phs_fenics/Temp_Simulation/Revision_Min/"
...
# plt.savefig(path_out + "Sim2_Hamiltonian.eps", format="eps")
#
# from matplotlib import cm
# from matplotlib.ticker import LinearLocator, FormatStrFormatter
# n_fig = 4
