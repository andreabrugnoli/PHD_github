...
where $\bm{e}_{\text{rod}} = (v_G; \; \omega_{G}), \; \bm{M}_{\text{rod}} = \mathrm{diag}(M_G, \, J_G)$. The interconnection matrix if obtained once the operator $\mathcal{W}^*$ is put into weak form
\begin{align*}
