...
The color of the box for each reviewer matches the text color used in the revised manuscript (in all cases but one when the revision is made for reviewer  \#1 but answer also a question by reviewer \#2), given below.
\begin{itemize}
...
\begin{tcolorbox}[title=Revision pages 18 to 24 (Reviewer No. 1 -- Comment 1),colframe=colorRevBG1]
...
For what concern the second question and other insights we invite reviewer~\#1 to refer to the answer in the response to part I.
\begin{tcolorbox}[title=Revision pages 20-21 (Reviewer No. 1 -- Comment 3),colframe=colorRevBG1]
...
\begin{tcolorbox}[title=Revision page 29 (Reviewer No. 1 -- Concluding remarks ),colframe=colorRevBG1]
...
\begin{quotebox}{Reviewer No.2 -- Paragraphs 2}
...
\begin{tcolorbox}[title=Revision page 15 (Reviewer No. 2),colframe=colorRevBG2]
...
\begin{quotebox}{Reviewer No.2 -- Paragraphs 3}
...
\end{quotebox}
\begin{tcolorbox}[title=Revision in part I pages 4 to 6 (Reviewer No. 2),colframe=colorRevBG2]
...
\end{itemize}
\end{quotebox}
\begin{tcolorbox}[title=Revision page 4 (Reviewer No. 2 -- Comment 1 and 2),colframe=colorRevBG2]
...
\begin{tcolorbox}[title=Revision page 5 (Reviewer No. 2 -- Comment 3),colframe=colorRevBG2]
...
page 6
	...
	\end{itemize}
\end{quotebox}
\begin{tcolorbox}[title=Revision page 5 (Reviewer No. 2 -- Comment 4),colframe=colorRevBG2]
...
\begin{tcolorbox}[title=Revision pages 6-7 (Reviewer No. 2 -- Comment 5),colframe=colorRevBG2]
...
\begin{quotebox}{Reviewer No.2 -- Comment 6}
 page 9:
	...
	\end{itemize}
\end{quotebox}
-\begin{tcolorbox}[title=Revision pages 8-9 (Reviewer No. 2 -- Comment 6),colframe=colorRevBG2]
...
\begin{quotebox}{Reviewer No.2 -- Comment 7}
	...
	\end{itemize}
\end{quotebox}
\begin{tcolorbox}[title=Revision page 12 (Reviewer No. 2 -- Comment 7),colframe=colorRevBG2]
Appropriate corrections have been performed.
\end{tcolorbox}
...
\begin{quotebox}{Reviewer No.2 -- Comment 8}
	...
	\begin{itemize}
		...
		\item  line 49: it is written We try to identify $A^*$ \dots rather write We shall	compute/identify \dots
	\end{itemize}
\end{quotebox}
\begin{tcolorbox}[title=Revision page 13 (Reviewer No. 2 -- Comment 8),colframe=colorRevBG2]
...
\begin{quotebox}{Reviewer No.2 -- Comment 10}
	...
	suggest to write precisely which of the equations are then integrated by parts.
	and write the choices of input variables to which this corresponds.
\end{quotebox}
\begin{tcolorbox}[title=Revision page 16 (Reviewer No. 2 -- Comment 10),colframe=colorRevBG2]
...
variable it corresponds and do the same with the remaining variables; give references to the choices of discretization basis that you mention. The sentence These elements are however difficult \dots level. is not understandable. Rather give references where it is used and why they are difficult to implement. What are the less regular elements, five examples, references and eventually references to standard/open FEM packages ?
...
with a more precise analysis of the well-posedness of the system in the input-output sense, generalizing to a second-order operator the results of Kurula and Zwart in the UT Memorandum 1994 The duality between the gradient
...
\begin{tcolorbox}[title=Revision pages 19-20 (Reviewer No. 2 -- Comment 11),colframe=colorRevBG2]
...
\begin{tcolorbox}[title=Revision pages 26 to 29 (Reviewer No. 2 -- Concluding remarks on References ),colframe=colorRevBG2]
