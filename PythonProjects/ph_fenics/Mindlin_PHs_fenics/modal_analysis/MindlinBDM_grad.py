...
P_qth = VectorElement('BDM', triangle, deg)
P_qw = FiniteElement('BDM', triangle, deg)
...
P_qn = FiniteElement('DG', triangle, deg-1)
P_Mnn = FiniteElement('DG', triangle, deg-1)
P_Mns = FiniteElement('DG', triangle, deg-1)
