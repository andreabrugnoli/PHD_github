...
# np.save('Data_Timo/A_sys', A_sys)
# np.save('Data_Timo/B_sys', B_sys)
# np.save('Data_Timo/C_sys', C_sys)
# np.save('Data_Timo/e0', e0)
# np.save('Data_Timo/dofs_dict', dofs_dict)
# np.save('Data_Timo/x_dict', x_dict)

scipy.io.savemat('Data_Timo/Data_Timo.mat', {"M": M, "J": J, "R": R, "B": B, "x0": e0})
