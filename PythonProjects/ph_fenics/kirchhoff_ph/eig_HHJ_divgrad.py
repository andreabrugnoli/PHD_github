...
e_mns_p = inner(e_q('+'), outer(n_ver('+'), s_ver('+')))
v_mns_p = inner(v_q('+'), outer(n_ver('+'), s_ver('+')))

e_ps = dot(grad(e_p), s_ver)
v_ps = dot(grad(v_p), s_ver)

e_ps_p = dot(grad(e_p('+')), s_ver('+'))
v_ps_p = dot(grad(v_p('+')), s_ver('+'))
