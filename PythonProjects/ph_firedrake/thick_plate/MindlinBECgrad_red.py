...
v_omn = dot(v_pth, n_ver)
v_oms = dot(v_pth, s_ver)
...
for key,val in bc_dict.items():
    if val == 'C':
        if key == 1 or key == 2:
            b_vec.append(v_pw * q_n * ds_v(key) + v_omn * M_nn * ds_v(key) + v_oms * M_ns * ds_v(key))
        elif key == 3:
            b_vec.append(v_pw * q_n * ds_b + v_omn * M_nn * ds_b + v_oms * M_ns * ds_b)
        else:
            b_vec.append(v_pw * q_n * ds_t + v_omn * M_nn * ds_t + v_oms * M_ns * ds_t)
    elif val == 'S':
        if key == 1 or key == 2:
            b_vec.append(v_pw * q_n * ds_v(key) + v_oms * M_ns * ds_v(key))
        elif key == 3:
            b_vec.append(v_pw * q_n * ds_b + v_oms * M_ns * ds_b)
        else:
            b_vec.append(v_pw * q_n * ds_t + v_oms * M_ns * ds_t)
