...
plt.title(r'$e_w$ error (CGDG element)')
plt.legend()
...
plt.title(r'$\bm{e}_\theta$ error (CGDG element)')
plt.legend()
if save_res:
...
plt.title(r'$\bm{E}_\kappa$ error (CGDG element)')
plt.legend()
if save_res:
...
plt.title(r'$\bm{e}_\gamma$ error (CGDG element)')
plt.legend()
if save_res:
