...
def construct_mech(n_elem, theta_cr):
    ...
    R_mech = la.block_diag(R_man, Z_lmb)
    ...
    fourbars = SysPhdaeRig(n_mech, nlmb_mech, nr_mech, np_mech, nq_mech, E=E_mech, J=J_mech, R=R_mech, B=B_mech)
...
M_e = E_sys[:-n_lmb, :-n_lmb] 
J_e = J_sys[:-n_lmb, :-n_lmb] 
R_e = R_sys[:-n_lmb, :-n_lmb] 
B_e = B_sys[:-n_lmb] 
...
# scipy.io.savemat('./Data_Karim/Data.mat', {"E": E_sys, "J": J_sys, "R": R_sys, "B": B_sys, "C": B_sys.T})
scipy.io.savemat('./Data_Karim/Data.mat', {"M": M_ode, "J": J_ode, "R": R_ode, "B": B_ode, "C": B_ode.T})
