...
def compute_err(n_el, n_t, deg=1, t_fin=1):
    ...
    for ii in tqdm(range(n_t)):
        ...
        b_form32 = m_form32(v_3, pn_3, v_2, un_2) + dt*(0.5*j_form32(v_3, pn_3, v_2, un_2) + bdflow32(v_2, p_y_mid))
