...
u1_err_deg3 = np.zeros((n_test_deg3,))
p0_err_deg3 = np.zeros((n_test_deg3,))
u2_err_deg3 = np.zeros((n_test_deg3,))

p30_err_deg3 = np.zeros((n_test_deg3,))
u12_err_deg3 = np.zeros((n_test_deg3,))

order_p3_deg3 = np.zeros((n_test_deg3 - 1,))
order_u1_deg3 = np.zeros((n_test_deg3 - 1,))
order_p0_deg3 = np.zeros((n_test_deg3 - 1,))
order_u2_deg3 = np.zeros((n_test_deg3 - 1,))
...
for i in range(n_test_deg3):
    ...
    if i>0:
        ...
        order_u1_deg3[i - 1] = np.log(u1_err_deg3[i] / u1_err_deg3[i - 1]) / np.log(h_vec_deg3[i] / h_vec_deg3[i - 1])

        order_p0_deg3[i - 1] = np.log(p0_err_deg3[i] / p0_err_deg3[i - 1]) / np.log(h_vec_deg3[i] / h_vec_deg3[i - 1])
        order_u2_deg3[i - 1] = np.log(u2_err_deg3[i] / u2_err_deg3[i - 1]) / np.log(h_vec_deg3[i] / h_vec_deg3[i - 1])
...
print("Estimated order of convergence for p_3: " + str(order_p3_deg3))
print("Estimated order of convergence for u_1: " + str(order_u1_deg3))

print("Estimated order of convergence for p_0: " + str(order_p0_deg3))
print("Estimated order of convergence for u_2: " + str(order_u2_deg3))

print("Estimated order of convergence for p_0 - p_3: " + str(order_p30_deg3))
print("Estimated order of convergence for u_2 - u_1: " + str(order_u12_deg3))
