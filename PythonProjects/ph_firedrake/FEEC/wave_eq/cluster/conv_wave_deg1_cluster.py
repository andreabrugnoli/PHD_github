...
for i in range(n_test_deg1):
    ...
    if i > 0:
        ...
        order_u1_deg1[i - 1, 0] = np.log(u1_err_deg1[i, 0] / u1_err_deg1[i - 1, 0]) / np.log(
            h_vec_deg1[i] / h_vec_deg1[i - 1])
        order_u1_deg1[i - 1, 1] = np.log(u1_err_deg1[i, 1] / u1_err_deg1[i - 1, 1]) / np.log(
            h_vec_deg1[i] / h_vec_deg1[i - 1])

        order_p0_deg1[i - 1, 0] = np.log(p0_err_deg1[i, 0] / p0_err_deg1[i - 1, 0]) / np.log(
            h_vec_deg1[i] / h_vec_deg1[i - 1])
        order_p0_deg1[i - 1, 1] = np.log(p0_err_deg1[i, 1] / p0_err_deg1[i - 1, 1]) / np.log(
            h_vec_deg1[i] / h_vec_deg1[i - 1])
