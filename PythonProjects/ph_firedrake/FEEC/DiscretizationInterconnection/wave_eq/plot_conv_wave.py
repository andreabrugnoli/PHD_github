...
for ii in deg_vec:
    ...
    plt.plot(np.log(h), np.log(h**ii) + \
             + 1.25*(np.log(errL2_p3)[-1] - np.log(h**ii)[-1]), '-v', label=r'$h^' + str(ii) + '$')
...
for ii in deg_vec:
    ...
    plt.plot(np.log(h), np.log(errL2_p0), '-.+', label=r'DL$_' + str(ii)+ '$')
    plt.plot(np.log(h), np.log(h**ii) + \
             + 1.25*(np.log(errL2_p0)[-1] - np.log(h**ii)[-1]), '-v', label=r'$h^' + str(ii) + '$')
...
for ii in deg_vec:
    ...
    plt.plot(np.log(h), np.log(errL2_u1), '-.+', label=r'DNED$^1_' + str(ii) + '$')
    plt.plot(np.log(h), np.log(h**ii) + \
             + 1.25*(np.log(errL2_u1)[-1] - np.log(h**ii)[-1]), '-v', label=r'$h^' + str(ii) + '$')
...
for ii in deg_vec:
    ...
    plt.plot(np.log(h), np.log(errL2_u2), '-.+', label=r'DRT$_' + str(ii) + '$')
    plt.plot(np.log(h), np.log(h**ii) + \
             + 1.25*(np.log(errL2_u2)[-1] - np.log(h**ii)[-1]), '-v', label=r'$h^' + str(ii) + '$')
...
for ii in deg_vec:
    ...
    plt.plot(np.log(h), np.log(h**ii) + \
             + 1.25*(np.log(errL2_u12)[-1] - np.log(h**ii)[-1]), '-v', label=r'$h^' + str(ii) + '$')
...
for ii in deg_vec:
    ...
    plt.plot(np.log(h), np.log(h**ii) + \
             + 1.25*(np.log(errL2_p30)[-1] - np.log(h**ii)[-1]), '-v', label=r'$h^' + str(ii) + '$')
