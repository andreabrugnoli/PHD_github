...
# path_result = '/home/a.brugnoli/GitProjects/PythonProjects/ph_fenics/Wave_fenics/results_ifacwc2/'

path_result = '/home/a.brugnoli/LargeFiles/results_ifacwc_firedrake/'
path_mesh = "/home/a.brugnoli/GitProjects/PythonProjects/ph_firedrake/waves/meshes_ifacwc/"
H_ref = np.load(path_result + H_file)
Hp_ref = np.load(path_result + Hp_file)
Hq_ref = np.load(path_result + Hq_file)
...
for i in range(n_mesh):
    ...
    # Vq_i = FunctionSpace(mesh_i, "RT", 2)
    #
